      ...
      <b-row class="m-0">
        ...
        <b-col sm="6" class="list-column">
          ...
          <b-row class="list-column-items">
            ...
            <div class="list-item" v-for="list in this.$store.state.dashboard.account.lists.active">
                ...
                <b-row class="item-group-header">
                  ...
                  <b-row class="header-info">
                    ...
                    <b-col class="item-block-mini" sm="3">
                      <span v-b-tooltip.hover title="Насыщенность списка, чем больше тем хуже."><font-awesome-icon class="icon-m conf" icon="burn" /></span>
        ...
        <b-col sm="6" class="list-column">
          ...
          <b-row class="list-column-items">
            ...
            <div class="list-item" v-for="list in this.$store.state.dashboard.account.lists.ready">
              <div class="list-item-group">
                ...
                <b-row class="item-group-header">
                  ...
                  <b-col class="header-title" sm="12">
                    ...
                    <div v-if="list.conf_str.post" v-show="list.conf_str.post">
                      <span class="font-weight-bold">
                        <a :href="list.conf_str.post.url" target="_blank">{{list.conf_str.post.url}}</a>
                      </span>
                    </div>
