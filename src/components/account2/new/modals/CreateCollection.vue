<template lang="html">
  ...
  <b-row v-if="this.$store.state.dashboard.account.ShowBody">
    ...
    <div class="ModalCollection">
      ...
      <!-- Modal Component -->
      <b-modal id="modallg" size="md" hide-header hide-footer>

        <b-col sm="12" class="CollectionBody">
              ...
              <b-form v-if="show">
                ...
                <div class="collection-right collection-right-profile" v-show="form.type_id == 2">
                  ...
                  <b-form-group id="InputGroupUserName"
                    ...
                    <b-button variant="outline-primary" @click="sendSearchProfile()">Поиск</b-button>
                  </b-form-group>
                ...
                <div class="collection-right active" v-show="form.type_id == 3">
                  ...
                  <b-form-group id="GroupInputSearch"
                    ...
                    <b-button variant="outline-primary" @click="sendSearchActive()">Поиск</b-button>
                  </b-form-group>

                  <div class="topsearch-items" v-if="items_search_active.show">
          ...
          <b-col sm="12" class="CollectionFooter">
            <div class="CreateBtnCenter">
              <!-- <b-button v-if="showBtnSave" @click="onSubmitForm" variant="primary">Сохранить</b-button> -->

              <div class="float-right">
                <b-button variant="danger" class="mr-3">Отменить</b-button>
                <b-button @click="onSubmitForm" variant="primary">Сохранить</b-button>
              </div>
              <div class="clearfix">
...
.ModalCollection .CollectionFooter {
  padding: 15px;
  border-top: 1px solid #ddd;
}
.CollectionFooter .CreateBtnCenter {
...
.topsearch-items .topsearch-item {
  ...
  background: #fff;
  /* border-radius: 4px; */
  /* -webkit-box-shadow: 0 4px 8px 0 #8fa6b36b; */
